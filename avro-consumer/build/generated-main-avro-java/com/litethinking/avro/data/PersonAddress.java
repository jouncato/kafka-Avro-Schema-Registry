...
public class PersonAddress extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8191134025799056058L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PersonAddress\",\"namespace\":\"com.litethinking.avro.data\",\"fields\":[{\"name\":\"person_id\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null},{\"name\":\"id_card_number\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null},{\"name\":\"full_name\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null},{\"name\":\"email\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null},{\"name\":\"address_id\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null},{\"name\":\"address\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null},{\"name\":\"city\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null},{\"name\":\"postal_code\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null}],\"connect.name\":\"com.litethinking.avro.data.PersonAddress\"}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static final SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<PersonAddress> ENCODER =
      new BinaryMessageEncoder<PersonAddress>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<PersonAddress> DECODER =
      new BinaryMessageDecoder<PersonAddress>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<PersonAddress> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<PersonAddress> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<PersonAddress> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<PersonAddress>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this PersonAddress to a ByteBuffer.
  ...
  /**
   * Deserializes a PersonAddress from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a PersonAddress instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static PersonAddress fromByteBuffer(
   ...
   */
  public PersonAddress(java.lang.String person_id, java.lang.String id_card_number, java.lang.String full_name, java.lang.String email, java.lang.String address_id, java.lang.String address, java.lang.String city, java.lang.String postal_code) {
  ...
  /**
   * Creates a new PersonAddress RecordBuilder.
   * @return A new PersonAddress RecordBuilder
   */
  public static com.litethinking.avro.data.PersonAddress.Builder newBuilder() {
    return new com.litethinking.avro.data.PersonAddress.Builder();
  }

  /**
   * Creates a new PersonAddress RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new PersonAddress RecordBuilder
   */
  public static com.litethinking.avro.data.PersonAddress.Builder newBuilder(com.litethinking.avro.data.PersonAddress.Builder other) {
    if (other == null) {
      return new com.litethinking.avro.data.PersonAddress.Builder();
    } else {
      return new com.litethinking.avro.data.PersonAddress.Builder(other);
    }
  }

  /**
   * Creates a new PersonAddress RecordBuilder by copying an existing PersonAddress instance.
   * @param other The existing instance to copy.
   * @return A new PersonAddress RecordBuilder
   */
  public static com.litethinking.avro.data.PersonAddress.Builder newBuilder(com.litethinking.avro.data.PersonAddress other) {
    if (other == null) {
      return new com.litethinking.avro.data.PersonAddress.Builder();
    } else {
      return new com.litethinking.avro.data.PersonAddress.Builder(other);
  ...
  /**
   * RecordBuilder for PersonAddress instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PersonAddress>
    implements org.apache.avro.data.RecordBuilder<PersonAddress> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.litethinking.avro.data.PersonAddress.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing PersonAddress instance
     * @param other The existing instance to copy.
     */
    private Builder(com.litethinking.avro.data.PersonAddress other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.person_id)) {
        this.person_id = data().deepCopy(fields()[0].schema(), other.person_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonAddress.Builder setPersonId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonAddress.Builder clearPersonId() {
      person_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonAddress.Builder setIdCardNumber(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonAddress.Builder clearIdCardNumber() {
      id_card_number = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonAddress.Builder setFullName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonAddress.Builder clearFullName() {
      full_name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonAddress.Builder setEmail(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonAddress.Builder clearEmail() {
      email = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonAddress.Builder setAddressId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonAddress.Builder clearAddressId() {
      address_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonAddress.Builder setAddress(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonAddress.Builder clearAddress() {
      address = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonAddress.Builder setCity(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonAddress.Builder clearCity() {
      city = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonAddress.Builder setPostalCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonAddress.Builder clearPostalCode() {
      postal_code = null;
    ...
    public PersonAddress build() {
      try {
        PersonAddress record = new PersonAddress();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<PersonAddress>
    WRITER$ = (org.apache.avro.io.DatumWriter<PersonAddress>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<PersonAddress>
    READER$ = (org.apache.avro.io.DatumReader<PersonAddress>)MODEL$.createDatumReader(SCHEMA$);
