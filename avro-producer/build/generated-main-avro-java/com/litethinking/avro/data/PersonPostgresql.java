 ...
 */
package com.litethinking.avro.data;
...
public class PersonPostgresql extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3118938967593166540L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PersonPostgresql\",\"namespace\":\"com.litethinking.avro.data\",\"fields\":[{\"name\":\"person_id\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null},{\"name\":\"id_card_number\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null},{\"name\":\"full_name\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null},{\"name\":\"email\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null},{\"name\":\"address_id\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null},{\"name\":\"address\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null},{\"name\":\"city\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null},{\"name\":\"postal_code\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null}],\"connect.name\":\"com.litethinking.avro.data.PersonAddressPostgresql\"}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static final SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<PersonPostgresql> ENCODER =
      new BinaryMessageEncoder<PersonPostgresql>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<PersonPostgresql> DECODER =
      new BinaryMessageDecoder<PersonPostgresql>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<PersonPostgresql> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<PersonPostgresql> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<PersonPostgresql> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<PersonPostgresql>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this PersonPostgresql to a ByteBuffer.
  ...
  /**
   * Deserializes a PersonPostgresql from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a PersonPostgresql instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static PersonPostgresql fromByteBuffer(
   ...
   */
  public PersonPostgresql(java.lang.String person_id, java.lang.String id_card_number, java.lang.String full_name, java.lang.String email, java.lang.String address_id, java.lang.String address, java.lang.String city, java.lang.String postal_code) {
  ...
  /**
   * Creates a new PersonPostgresql RecordBuilder.
   * @return A new PersonPostgresql RecordBuilder
   */
  public static com.litethinking.avro.data.PersonPostgresql.Builder newBuilder() {
    return new com.litethinking.avro.data.PersonPostgresql.Builder();
  }

  /**
   * Creates a new PersonPostgresql RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new PersonPostgresql RecordBuilder
   */
  public static com.litethinking.avro.data.PersonPostgresql.Builder newBuilder(com.litethinking.avro.data.PersonPostgresql.Builder other) {
    if (other == null) {
      return new com.litethinking.avro.data.PersonPostgresql.Builder();
    } else {
      return new com.litethinking.avro.data.PersonPostgresql.Builder(other);
    }
  }

  /**
   * Creates a new PersonPostgresql RecordBuilder by copying an existing PersonPostgresql instance.
   * @param other The existing instance to copy.
   * @return A new PersonPostgresql RecordBuilder
   */
  public static com.litethinking.avro.data.PersonPostgresql.Builder newBuilder(com.litethinking.avro.data.PersonPostgresql other) {
    if (other == null) {
      return new com.litethinking.avro.data.PersonPostgresql.Builder();
    } else {
      return new com.litethinking.avro.data.PersonPostgresql.Builder(other);
  ...
  /**
   * RecordBuilder for PersonPostgresql instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PersonPostgresql>
    implements org.apache.avro.data.RecordBuilder<PersonPostgresql> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.litethinking.avro.data.PersonPostgresql.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing PersonPostgresql instance
     * @param other The existing instance to copy.
     */
    private Builder(com.litethinking.avro.data.PersonPostgresql other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.person_id)) {
        this.person_id = data().deepCopy(fields()[0].schema(), other.person_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonPostgresql.Builder setPersonId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonPostgresql.Builder clearPersonId() {
      person_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonPostgresql.Builder setIdCardNumber(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonPostgresql.Builder clearIdCardNumber() {
      id_card_number = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonPostgresql.Builder setFullName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonPostgresql.Builder clearFullName() {
      full_name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonPostgresql.Builder setEmail(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonPostgresql.Builder clearEmail() {
      email = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonPostgresql.Builder setAddressId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonPostgresql.Builder clearAddressId() {
      address_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonPostgresql.Builder setAddress(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonPostgresql.Builder clearAddress() {
      address = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonPostgresql.Builder setCity(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonPostgresql.Builder clearCity() {
      city = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonPostgresql.Builder setPostalCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.litethinking.avro.data.PersonPostgresql.Builder clearPostalCode() {
      postal_code = null;
    ...
    public PersonPostgresql build() {
      try {
        PersonPostgresql record = new PersonPostgresql();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<PersonPostgresql>
    WRITER$ = (org.apache.avro.io.DatumWriter<PersonPostgresql>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<PersonPostgresql>
    READER$ = (org.apache.avro.io.DatumReader<PersonPostgresql>)MODEL$.createDatumReader(SCHEMA$);
